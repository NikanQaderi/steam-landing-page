...
var salagameGames = [
  {
    ...
    points: "100,000",
    tags: ["multiplayer", "shooter", "openworld"],
  },
  {
    id: "2",
    pic: "saleGameItem02",
...
for (let i = 0; i < featuredSliderData.length; i++) {
  ...
  let image = document.createElement("img");
  image.src =
    "game-image/featuredSlider/capsule_616x353" + featuredSliderData[i].pic;
